...
public class TransactionSpecifications{
    ...
    public static Specification<Transaction> byDateRange(LocalDate start, LocalDate end) {
    ...
    public static Specification<Transaction> byMonthAndYear(int month, int year) {
        ...
        if (thirtyDaysMonth.contains(month)) {
        	...
        	return (root, query, cb) -> cb.between(root.get("date"), LocalDate.now(), LocalDate.now());
        }
